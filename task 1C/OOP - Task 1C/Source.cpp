...
void main()
{
	...
	u1->library.addAtEnd(new LibraryItem(Date(17, 6, 2018), app.GetStore().games.getListItem(0), 0.0f));
	u1->library.addAtEnd(new LibraryItem(Date(18, 6, 2018), app.GetStore().games.getListItem(1), 0.0f));
	u2->library.addAtEnd(new LibraryItem(Date(19, 9, 2018), app.GetStore().games.getListItem(2), 0.0f));
	u2->library.addAtEnd(new LibraryItem(Date(19, 9, 2018), app.GetStore().games.getListItem(3), 0.0f));
	u3->library.addAtEnd(new LibraryItem(Date(24, 9, 2018), app.GetStore().games.getListItem(3), 0.0f));
	u3->library.addAtEnd(new LibraryItem(Date(30, 9, 2018), app.GetStore().games.getListItem(6), 0.0f));
