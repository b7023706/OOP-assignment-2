...
void main()
{
	...
	Account* a1 = new Account("alice@shu.com", "password", Date(16, 6, 2018));
	Account* a2 = new Account("Bob@shu.com", "password", Date(20, 4, 2018));
	Account* a3 = new Account("Charlie@shu.com", "password", Date(11, 9, 2018));
